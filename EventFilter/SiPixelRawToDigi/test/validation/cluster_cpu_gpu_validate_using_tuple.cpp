...
// > g++ cluster_cpu_gpu_validate_using_tuple.cpp -std=gnu++11 -o out
// > ./out
...
typedef tuple<int, int, int> cluster_tuple;
...
int main(void){
  ...
  int iprev_id, i0, i1, i2, j0, j1, j2;
  int ClusterID, XX, YY;
  ...
  icnt=0; icpu_mismatch=0; tot_cpu_clusters=0; iprev_id=-1;
  ...
  icnt=0; igpu_mismatch=0; igpu_mismatch=0; iprev_id=-1;
